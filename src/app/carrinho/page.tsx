            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="font-medium text-gray-900">Finalização do Pedido</h2>
                </div>
                
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 p-5 rounded-lg shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700 mb-3">
                        Nosso time de vendas irá calcular o melhor frete para sua região e confirmar todos os detalhes do pedido diretamente com você.
                      </p>
              ...
              {/* Seção de Cálculo de Frete Comentada - Finalização apenas via WhatsApp */}
              {/* <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center gap-2 mb-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 text-xs">
                    A calcular via WhatsApp
                  </span>
                </div>
                <div className="pt-3 border-t border-gray-100">
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-gray-900">Total de Produtos</span>
                    <div className="text-right">
